...
Singleton {
    ...
    colors: QtObject {
        ...
        property color colPrimaryContainer: ColorUtils.transparentize(m3colors.m3surfaceVariant, 0.5)
        ...
        property color colBackgroundSurfaceContainer: ColorUtils.transparentize(m3colors.m3background, root.backgroundTransparency)
